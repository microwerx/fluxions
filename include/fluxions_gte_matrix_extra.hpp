...
class TMatrixM
{
  public:
	...
	TMatrixM(const TMatrixM<T> &M) : m11(M.m11), m12(M.m12), m13(M.m13), m14(M.m14),
	...
	TMatrixM(const T M[16]) : m11(M[0]), m12(M[4]), m13(M[8]), m14(M[12]),
	...
	const TMatrixM<T> AsTranspose() const
	{
		return TMatrixM<T>(
			t11, t21, t31, t41,
			t12, t22, t32, t42,
