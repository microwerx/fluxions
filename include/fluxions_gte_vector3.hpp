...
namespace Fluxions
{
	...
	public:
		...
		template <typename U> operator TVector3<U>() const
		{
			return TVector3<U>(
				static_cast<U>(x),
				static_cast<U>(y),
	...
	template <> constexpr TVector3<uint8_t> TVector3<uint8_t>::operator - () noexcept
	{
		return TVector3<uint8_t>(x, y, z);
	}
	template <>	constexpr TVector3<uint16_t> TVector3<uint16_t>::operator - () noexcept
	{
		return TVector3<uint16_t>(x, y, z);
	}
	template <>	constexpr TVector3<uint32_t> TVector3<uint32_t>::operator - () noexcept
	{
		return TVector3<uint32_t>(x, y, z);
	}
	template <>	constexpr TVector3<uint64_t> TVector3<uint64_t>::operator - () noexcept
	{
