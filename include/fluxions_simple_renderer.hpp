...
namespace Fluxions
{
	...
	public:
		...
		inline void SetProgramUniform(GLint uniformLocation)
		{
			...
			{
				if (components == 1) whichType = GL_FLOAT;
				else if (components == 2) whichType = GL_FLOAT_VEC2;
				else if (components == 3) whichType = GL_FLOAT_VEC3;
				else if (components == 4) whichType = GL_FLOAT_VEC4;
			}
			else if (baseType == GL_INT)
			{
				if (components == 1) whichType = GL_INT;
				else if (components == 2) whichType = GL_INT_VEC2;
				else if (components == 3) whichType = GL_INT_VEC3;
				else if (components == 4) whichType = GL_INT_VEC4;
			}
			else if (baseType == GL_UNSIGNED_INT)
			{
				if (components == 1) whichType = GL_UNSIGNED_INT;
				else if (components == 2) whichType = GL_UNSIGNED_INT_VEC2;
				else if (components == 3) whichType = GL_UNSIGNED_INT_VEC3;
				else if (components == 4) whichType = GL_UNSIGNED_INT_VEC4;
			}
			switch (whichType)
			{
			case GL_FLOAT: glUniform1fv(uniformLocation, count, (GLfloat *)&buffer[0]); break;
			case GL_FLOAT_VEC2: glUniform2fv(uniformLocation, count, (GLfloat *)&buffer[0]); break;
			case GL_FLOAT_VEC3: glUniform3fv(uniformLocation, count, (GLfloat *)&buffer[0]); break;
			case GL_FLOAT_VEC4: glUniform4fv(uniformLocation, count, (GLfloat *)&buffer[0]); break;
			case GL_INT: glUniform1iv(uniformLocation, count, (GLint *)&buffer[0]); break;
			case GL_INT_VEC2: glUniform2iv(uniformLocation, count, (GLint *)&buffer[0]); break;
			case GL_INT_VEC3: glUniform3iv(uniformLocation, count, (GLint *)&buffer[0]); break;
			case GL_INT_VEC4: glUniform4iv(uniformLocation, count, (GLint *)&buffer[0]); break;
			case GL_UNSIGNED_INT: glUniform1uiv(uniformLocation, count, (GLuint *)&buffer[0]); break;
			case GL_UNSIGNED_INT_VEC2: glUniform2uiv(uniformLocation, count, (GLuint *)&buffer[0]); break;
			case GL_UNSIGNED_INT_VEC3: glUniform3uiv(uniformLocation, count, (GLuint *)&buffer[0]); break;
			case GL_UNSIGNED_INT_VEC4: glUniform4uiv(uniformLocation, count, (GLuint *)&buffer[0]); break;
			case GL_FLOAT_MAT2: glUniformMatrix2fv(uniformLocation, count, transpose, (GLfloat *)&buffer[0]); break;
			case GL_FLOAT_MAT3: glUniformMatrix3fv(uniformLocation, count, transpose, (GLfloat *)&buffer[0]); break;
			case GL_FLOAT_MAT4: glUniformMatrix4fv(uniformLocation, count, transpose, (GLfloat *)&buffer[0]); break;
			case GL_FLOAT_MAT2x3: glUniformMatrix2x3fv(uniformLocation, count, transpose, (GLfloat *)&buffer[0]); break;
			case GL_FLOAT_MAT2x4: glUniformMatrix2x4fv(uniformLocation, count, transpose, (GLfloat *)&buffer[0]); break;
			case GL_FLOAT_MAT3x2: glUniformMatrix3x2fv(uniformLocation, count, transpose, (GLfloat *)&buffer[0]); break;
			case GL_FLOAT_MAT3x4: glUniformMatrix3x4fv(uniformLocation, count, transpose, (GLfloat *)&buffer[0]); break;
			case GL_FLOAT_MAT4x2: glUniformMatrix4x2fv(uniformLocation, count, transpose, (GLfloat *)&buffer[0]); break;
			case GL_FLOAT_MAT4x3: glUniformMatrix4x3fv(uniformLocation, count, transpose, (GLfloat *)&buffer[0]); break;
			case GL_DOUBLE_MAT2: glUniformMatrix2dv(uniformLocation, count, transpose, (GLdouble *)&buffer[0]); break;
			case GL_DOUBLE_MAT3: glUniformMatrix3dv(uniformLocation, count, transpose, (GLdouble *)&buffer[0]); break;
			case GL_DOUBLE_MAT4: glUniformMatrix4dv(uniformLocation, count, transpose, (GLdouble *)&buffer[0]); break;
			case GL_DOUBLE_MAT2x3: glUniformMatrix2x3dv(uniformLocation, count, transpose, (GLdouble *)&buffer[0]); break;
			case GL_DOUBLE_MAT2x4: glUniformMatrix2x4dv(uniformLocation, count, transpose, (GLdouble *)&buffer[0]); break;
			case GL_DOUBLE_MAT3x2: glUniformMatrix3x2dv(uniformLocation, count, transpose, (GLdouble *)&buffer[0]); break;
			case GL_DOUBLE_MAT3x4: glUniformMatrix3x4dv(uniformLocation, count, transpose, (GLdouble *)&buffer[0]); break;
			case GL_DOUBLE_MAT4x2: glUniformMatrix4x2dv(uniformLocation, count, transpose, (GLdouble *)&buffer[0]); break;
			case GL_DOUBLE_MAT4x3: glUniformMatrix4x3dv(uniformLocation, count, transpose, (GLdouble *)&buffer[0]); break;
			}
		}
