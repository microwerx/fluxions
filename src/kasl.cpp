...
namespace KASL
{
	...
	ostream & operator << (ostream & ostr, const TokenType & type)
	{
		switch (type)
		{
		case TokenType::TT0_CHAR: ostr << "TT0_CHAR"; break;
		case TokenType::TT0_SPACE: ostr << "TT0_SPACE"; break;
		case TokenType::TT0_TAB: ostr << "TT0_TAB"; break;
		case TokenType::TT0_NEWLINE: ostr << "TT0_NEWLINE"; break;
		case TokenType::TT0_DIGIT: ostr << "TT0_DIGIT"; break;
		case TokenType::TT0_ALPHA: ostr << "TT0_ALPHA"; break;
		case TokenType::TT0_CNTRL: ostr << "TT0_CNTRL"; break;
		case TokenType::TT0_PUNCT: ostr << "TT0_PUNCT"; break;
		case TokenType::TT1_EXCLAMATION_POINT: ostr << "TT1_EXCLAMATION_POINT"; break;
		case TokenType::TT1_DOUBLE_QUOTE: ostr << "TT1_DOUBLE_QUOTE"; break;
		case TokenType::TT1_NUMBER_SIGN: ostr << "TT1_NUMBER_SIGN"; break;
		case TokenType::TT1_DOLLAR_SIGN: ostr << "TT1_DOLLAR_SIGN"; break;
		case TokenType::TT1_PERCENT_SIGN: ostr << "TT1_PERCENT_SIGN"; break;
		case TokenType::TT1_AMPERSAND: ostr << "TT1_AMPERSAND"; break;
		case TokenType::TT1_SINGLE_QUOTE: ostr << "TT1_SINGLE_QUOTE"; break;
		case TokenType::TT1_LPAREN: ostr << "TT1_LPAREN"; break;
		case TokenType::TT1_RPAREN: ostr << "TT1_RPAREN"; break;
		case TokenType::TT1_ASTERICK: ostr << "TT1_ASTERICK"; break;
		case TokenType::TT1_PLUS_SIGN: ostr << "TT1_PLUS_SIGN"; break;
		case TokenType::TT1_COMMA: ostr << "TT1_COMMA"; break;
		case TokenType::TT1_DASH: ostr << "TT1_DASH"; break;
		case TokenType::TT1_PERIOD: ostr << "TT1_PERIOD"; break;
		case TokenType::TT1_FORWARD_SLASH: ostr << "TT1_FORWARD_SLASH"; break;
		case TokenType::TT1_COLON: ostr << "TT1_COLON"; break;
		case TokenType::TT1_SEMICOLON: ostr << "TT1_SEMICOLON"; break;
		case TokenType::TT1_LESS_THAN_SIGN: ostr << "TT1_LESS_THAN_SIGN"; break;
		case TokenType::TT1_EQUAL_SIGN: ostr << "TT1_EQUAL_SIGN"; break;
		case TokenType::TT1_GREATER_THAN_SIGN: ostr << "TT1_GREATER_THAN_SIGN"; break;
		case TokenType::TT1_QUESTION_MARK: ostr << "TT1_QUESTION_MARK"; break;
		case TokenType::TT1_AT_SYMBOL: ostr << "TT1_AT_SYMBOL"; break;
		case TokenType::TT1_LBRACKET: ostr << "TT1_LBRACKET"; break;
		case TokenType::TT1_BACK_SLASH: ostr << "TT1_BACK_SLASH"; break;
		case TokenType::TT1_RBRACKET: ostr << "TT1_RBRACKET"; break;
		case TokenType::TT1_CARET: ostr << "TT1_CARET"; break;
		case TokenType::TT1_UNDERSCORE: ostr << "TT1_UNDERSCORE"; break;
		case TokenType::TT1_GRAVE_ACCENT: ostr << "TT1_GRAVE_ACCENT"; break;
		case TokenType::TT1_LBRACE: ostr << "TT1_LBRACE"; break;
		case TokenType::TT1_VERTICAL_BAR: ostr << "TT1_VERTICAL_BAR"; break;
		case TokenType::TT1_RBRACE: ostr << "TT1_RBRACE"; break;
		case TokenType::TT1_TILDE: ostr << "TT1_TILDE"; break;
		case TokenType::TT2_ID: ostr << "TT2_ID"; break;
		case TokenType::TT2_STRING: ostr << "TT2_STRING"; break;
		case TokenType::TT2_DOUBLE: ostr << "TT2_DOUBLE"; break;
		case TokenType::TT2_INTEGER: ostr << "TT2_INTEGER"; break;
		case TokenType::TT2_HEXINTEGER: ostr << "TT2_HEXINTEGER"; break;
		}
		return ostr;
	}
	...
	size_t lex_quick_l3_parse(const StringType &inputStr, TokenVector &tokens)
	{
		...
		while (i < count)
		{
			...
			else if (tk[i].IsType(TokenType::TT1_NUMBER_SIGN)) return 0;
			else if (
				tk[i].IsType(TokenType::TT1_FORWARD_SLASH) &&
				i+1 < count &&
				tk[i + 1].IsType(TokenType::TT1_FORWARD_SLASH))
				return 0;
			i++;
		}
		...
		for (auto it : tk)
		{
			...
			else if (!it.IsType(TokenType::TT0_SPACE) &&
				!it.IsType(TokenType::TT0_TAB) &&
				!it.IsType(TokenType::TT0_NEWLINE))
			{
				tmp.sval += it.sval;
	...
	size_t lex(LexerState &ls, const StringType &inputStr, int level)
	{
		...
		for (auto i = start; i < length; i++)
		{
			...
			if (!gobbledL2 && level >= 1)
			{
				...
				if (ispunct(c) && c != '_') keepContinguous = false;
			}
			if (!gobbledL2 && !gobbledL1 && level >= 0)
			{
				...
				else if (ispunct(c))
				{
					...
					if (level >= 1) keepContinguous = false;
				}
				else if (iscntrl(c))
				{
			...
			if (ls.tmptoken.type == TokenType::TT0_NOTHING) continue;
