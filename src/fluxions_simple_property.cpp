...
namespace Fluxions
{
	...
	const string PropertyTypeToString(PropertyType propertyType)
	{
		switch (propertyType)
		{
		case PropertyType::NOTHING: return string("NOTHING");
		case PropertyType::STRUCT: return string("STRUCT");
		case PropertyType::ARRAY: return string("ARRAY");
		...
		case PropertyType::VEC2: return string("VEC2");
		case PropertyType::VEC3: return string("VEC3");
		case PropertyType::VEC4: return string("VEC4");
		case PropertyType::BVEC2: return string("BVEC2");
		case PropertyType::BVEC3: return string("BVEC3");
		case PropertyType::BVEC4: return string("BVEC4");
		case PropertyType::IVEC2: return string("IVEC2");
		case PropertyType::IVEC3: return string("IVEC3");
		case PropertyType::IVEC4: return string("IVEC4");
		case PropertyType::MAT2: return string("MAT2");
		case PropertyType::MAT3: return string("MAT3");
		case PropertyType::MAT4: return string("MAT4");
		case PropertyType::SAMPLER2D: return string("SAMPLER2D");
		case PropertyType::SAMPLERCUBE: return string("SAMPLERCUBE");
		case PropertyType::UINT: return string("UINT");
		case PropertyType::UVEC2: return string("UVEC2");
		case PropertyType::UVEC3: return string("UVEC3");
		case PropertyType::UVEC4: return string("UVEC4");
		case PropertyType::MAT2X2: return string("MAT2X2");
		case PropertyType::MAT2X3: return string("MAT2X3");
		case PropertyType::MAT2X4: return string("MAT2X4");
		case PropertyType::MAT3X2: return string("MAT3X2");
		case PropertyType::MAT3X3: return string("MAT3X3");
		case PropertyType::MAT3X4: return string("MAT3X4");
		case PropertyType::MAT4X2: return string("MAT4X2");
		case PropertyType::MAT4X3: return string("MAT4X3");
		case PropertyType::MAT4X4: return string("MAT4X4");
		case PropertyType::SAMPLER3D: return string("SAMPLER3D");
		case PropertyType::SAMPLERCUBESHADOW: return string("SAMPLERCUBESHADOW");
		case PropertyType::SAMPLER2DSHADOW: return string("SAMPLER2DSHADOW");
		case PropertyType::SAMPLER2DARRAY: return string("SAMPLER2DARRAY");
		case PropertyType::SAMPLER2DARRAYSHADOW: return string("SAMPLER2DARRAYSHADOW");
		case PropertyType::ISAMPLER2D: return string("ISAMPLER2D");
		case PropertyType::ISAMPLER3D: return string("ISAMPLER3D");
		case PropertyType::ISAMPLERCUBE: return string("ISAMPLERCUBE");
		case PropertyType::ISAMPLER2DARRAY: return string("ISAMPLER2DARRAY");
		case PropertyType::USAMPLER2D: return string("USAMPLER2D");
		case PropertyType::USAMPLER3D: return string("USAMPLER3D");
		case PropertyType::USAMPLERCUBE: return string("USAMPLERCUBE");
		case PropertyType::USAMPLER2DARRAY: return string("USAMPLER2DARRAY");
		case PropertyType::ISAMPLER2DMS: return string("ISAMPLER2DMS");
		case PropertyType::IIMAGE2D: return string("IIMAGE2D");
		case PropertyType::IIMAGE3D: return string("IIMAGE3D");
		case PropertyType::IIMAGECUBE: return string("IIMAGECUBE");
		case PropertyType::IIMAGE2DARRAY: return string("IIMAGE2DARRAY");
		case PropertyType::ATOMIC_UINT: return string("ATOMIC_UINT");
		case PropertyType::USAMPLER2DMS: return string("USAMPLER2DMS");
		case PropertyType::UIMAGE2D: return string("UIMAGE2D");
		case PropertyType::UIMAGE3D: return string("UIMAGE3D");
		case PropertyType::UIMAGECUBE: return string("UIMAGECUBE");
		case PropertyType::UIMAGE2DARRAY: return string("UIMAGE2DARRAY");
		case PropertyType::SAMPLER2DMS: return string("SAMPLER2DMS");
		case PropertyType::IMAGE2D: return string("IMAGE2D");
		case PropertyType::IMAGE3D: return string("IMAGE3D");
		case PropertyType::IMAGECUBE: return string("IMAGECUBE");
		case PropertyType::IMAGE2DARRAY: return string("IMAGE2DARRAY");
		case PropertyType::MAXVALUETYPE: return string("MAXVALUETYPE");
		case PropertyType::UNIFORM_BLOCK: return string("UNIFORM_BLOCK");
		case PropertyType::BUFFER_BLOCK: return string("BUFFER_BLOCK");
		}
	...
	int test_fluxions_simple_property(int argc, char **argv)
	{
		...
		*/
		...
		if (iptr1 != nullptr) cout << "value = " << *iptr1 << endl;
		...
		if (iptr2 != nullptr) cout << "value = " << *iptr2 << endl;
		...
		if (fptr1) cout << "fptr1 = " << *fptr1 << endl;
		...
		if (fptr2) cout << "fptr2 = " << *fptr2 << endl;
