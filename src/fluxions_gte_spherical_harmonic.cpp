...
namespace Fluxions
{
	...
	T calc_degree_7(const T *a, T theta, T phi) {
		...
		return T180*t25*a[63] * t26 - T181*t25*a[49] * t26 + T182*t23*a[62] * t1*t24 +
			...
			T192*t8*a[57] * t9*t10 - T193*t8*a[55] * t9*t10 + T194*a[56] *
			(T195*t2 - T196*pow(t2, 7) + T197*t7 - T198*t6 + T199*t5 - T200*t4 + T201*t3 + T202);
	}
	...
	T calc_degree_8(const T *a, T theta, T phi) {
		...
		T t29 = cos(T245*phi);
		T t30 = pow(t11, 8);
		return T246*t29*a[80] * t30 + T247*t29*a[64] * t30 + T248*t27*a[79] * t1*t28 - T249*t27*a[65] *
			t1*t28 + T250*t24*a[78] * t25*t26 + T251*t24*a[66] * t25*t26 + T252*t21*a[77] * t22*t23 -
			...
			T259*t12*a[70] * t13*t14 + T260*t9*a[73] * t10*t11 - T261*t9*a[71] * t10*t11 + T262*a[72] *
			(T263*t2 + T264*pow(t2, 8) - T265*t8 + T266*t7 - T267*t6 + T268*t5 - T269*t4 + T270*t3 + T271);
	}
	...
	T calc_degree_9(const T *a, T theta, T phi) {
		...
		T t33 = cos(T324*phi);
		T t34 = pow(t12, 9);
		return T325*t33*a[99] * t34 - T326*t33*a[81] * t34 + T327*t31*a[98] * t1*t32 + T328*t31*a[82] *
			t1*t32 + T329*t28*a[97] * t29*t30 - T330*t28*a[83] * t29*t30 + T331*t25*a[96] * t26*t27 +
			...
			T341*t10*a[91] * t11*t12 - T342*t10*a[89] * t11*t12 + T343*a[90] * (T344*t2 - T345*pow(t2, 9) +
				T346*t9 - T347*t8 + T348*t7 - T349*t6 + T350*t5 - T351*t4 + T352*t3 + T353);
	}
	...
	T calc_degree_10(const T *a, T theta, T phi) {
		...
		return T418*t37*a[120] * t38 + T419*t37*a[100] * t38 + T420*t35*a[119] * t1*t36 -
			...
			T436*t11*a[111] * t12*t13 - T437*t11*a[109] * t12*t13 + T438*a[110] *
			(T439*t2 + T440*pow(t2, 10) - T441*t10 + T442*t9 - T443*t8 + T444*t7 - T445*t6 +
				T446*t5 - T447*t4 + T448*t3 + T449);
	}
	...
	void Sph4f::SaveJSON(const string & path)
	{
		...
		KASL::JSONPtr json = KASL::JSON::MakeObject({
			{ "maxDegree", KASL::JSON::MakeNumber(msph[0].GetMaxDegree()) },
