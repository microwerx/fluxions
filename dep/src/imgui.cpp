...
/*
 ...
 - 2015/06/14 (1.41) - changed ImageButton() default bg_col parameter from (0,0,0,1) (black) to (0,0,0,0) (transparent) - makes a difference when texture_ have transparence
 ...
 A: ImTextureID is a void* used to pass renderer-agnostic texture_ references around until it hits your render function.
    ...
    It could be an identifier to your OpenGL texture_ (cast GLuint to void*), a pointer to your custom engine material (cast MyMaterial* to void*), etc.
    At the end of the chain, your renderer takes this void* to cast it back into whatever it needs to select a current texture_ to render.
    Refer to examples applications, where each renderer (in a imgui_impl_xxxx.cpp file) is treating ImTextureID as a different thing.
    (c++ tip: OpenGL uses integers to identify textures. You can safely store an integer into a void*, just cast it to void*, don't take it's address!)
    To display a custom image/texture_ within an ImGui window, you may use ImGui::Image(), ImGui::ImageButton(), ImDrawList::AddImage() functions.
...
!- color: the color helpers/typing is a mess and needs sorting out.
 ...
 - style/optimization: store rounded corners in texture_ to use 1 quad per corner (filled and wireframe) to lower the cost of rounding.
...
!- keyboard: tooltip & combo boxes are messing up / not honoring keyboard tabbing
 ...
 - drawlist: end-user probably can't call Clear() directly because we expect a texture_ to be pushed in the stack.
...
bool ImGui::Begin(const char* name, bool* p_open, const ImVec2& size_on_first_use, float bg_alpha, ImGuiWindowFlags flags)
{
    ...
    if (first_begin_of_the_frame)
    {
        ...
        // Clear draw list, setup texture_, outer clipping rectangle
...
bool ImGui::ImageButton(ImTextureID user_texture_id, const ImVec2& size, const ImVec2& uv0, const ImVec2& uv1, int frame_padding, const ImVec4& bg_col, const ImVec4& tint_col)
{
    ...
    // Default to using texture_ ID as ID. User can still push string/integer prefixes.
